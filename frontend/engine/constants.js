...
export const TILE_COLOURS = {
    0: { fill: "#f5f5f0", stroke: "#d4d4cc" }, // walkable tile
    1: { fill: "#1e1e2e", stroke: "#2a2a3e" }, // obstacle or wall
    2: { fill: "#22c55e", stroke: "#16a34a" }, // goal or exit
    3: { fill: "#3b82f6", stroke: "#2563eb" }, // spawn location
};
